...
public class Driver {
    ...
    /**
     * Randomly chooses two members of the current population, breeds them, and adds the children to the new population
    ...
    /**
     * Mutates 10% of the new population after breeding step. In this case 2 chromosomes
